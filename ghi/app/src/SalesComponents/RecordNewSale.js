    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <select value={selectedAutomobileVIN} onChange={e => setSelectedAutomobileVIN(e.target.value)} required>
        ...
        <div>
          ...
          <select value={selectedSalespersonID} onChange={e => setSelectedSalespersonID(e.target.value)} required>
            <option value="">Select a Salesperson</option>
            {salespeople.map(sp => (
              <option key={sp.employee_id} value={sp.employee_id}>{`${sp.first_name} ${sp.last_name}`}</option>
            ))}
          </select>
        </div>
        <div>
